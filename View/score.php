	...
	<div class="callout">
		...
		<div class="row">
			<div class="large-8 columns">
				<div class="button-group">
					<button class="disabled button">Top 5</button>
					<button class="button">Top 10</button>
					<button class="button">Top 20</button>
				</div>
			</div>
			<div class="large-4 columns">
				<div class="row collapse">
					...
					<div class="small-4 columns">
						<button class="warning button expanded">Search</button>
					</div>
				</div>
			</div>
			<hr>
		...
		<div class="row">
			<div class="large-12 columns" style="text-align: center">
				<button class="success large button">Challenge</button>
			</div>
		</div>
	</div>
</div>
